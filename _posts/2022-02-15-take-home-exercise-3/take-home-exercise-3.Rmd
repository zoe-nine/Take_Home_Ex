...
## 1.1 Comparison between Tableau and R
Tableau has limited tools in handling multivariate data analysis whereas R could be used to visualise and analyse multidimensional continuous and categorical data through several techniques:  
...
## 1.2 Installing relevant packages
